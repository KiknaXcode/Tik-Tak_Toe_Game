...
function detectWinner(){
    ...
    for(let i=0; i<3; i++){
        ...
        }else if (mainBoard[0][i] == mainBoard[1][i] && mainBoard[1][i] == mainBoard[2][i] && mainBoard[0][i] != " "){
            boxesArray.forEach((item) =>{
                if(item.innerText == currentPlayer){
                    item.classList.add("winner-style");
                }
    ...
    }else if(mainBoard[2][0] == mainBoard[1][1] && mainBoard[1][1] == mainBoard[0][2] && mainBoard[2][0] != " "){
        boxesArray.forEach((item) =>{
            if(item.innerText == currentPlayer){
                item.classList.add("winner-style");
            }
